...
fits the HMM-LogOU via Baum-Welch, prints diagnostics, writes the calibrated params as JSON.
    ...
    python experiments/calibrate_hmm_logou.py --csv data/platinum_eod.csv --states 3 --iters 200
"""
import argparse
import json
...
from derivus.stochasticprocess import MarkovSwitchingLogOUSpotCalibration
