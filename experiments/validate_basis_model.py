"""Validation tests A-D for BasisLinkedSpotModel against the section 6 reference values.
...
from derivus.stochasticprocess import BasisLinkedSpotCalibration
