...
toy's BOUNDED behaviour at depth. Stage 2 swaps the analytic dynamics for the derivus bundle's
...
# --------------------------------------------------------------------------- #
# Problem constants (toy values; Stage 2 reads these from the derivus runtime)
# --------------------------------------------------------------------------- #
