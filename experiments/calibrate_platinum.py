...
Usage:
    python experiments/calibrate_platinum.py --marketdata tests/fixtures/data/MarketDataRF_platinum.json \\
...
def main():
    ...
    parser.add_argument('--marketdata', default='./tests/fixtures/data/MarketDataRF_platinum.json',
                        help='Source MarketDataRF.json — Model Configuration drives factor routing.')
    parser.add_argument('--calibration-config', default='./tests/fixtures/calibration_config.json',
                        help='Calibration_config.json (test variants live in artifacts/).')
    parser.add_argument('--out', default='./tests/fixtures/data/MarketDataRF_platinum_calibrated.json',
