...
mock-built suite, so those readings are a record and the Malz lookup is untested at a single
expiry as well as ACROSS expiries, where the term interpolation runs in total variance.
