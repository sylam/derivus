...
The fastest way to use derivus is to install jupyter and [riskflow_widgets](https://github.com/sylam/riskflow_widgets).
The User Interface for derivus is called [derivus_jupyter](https://github.com/sylam/derivus/raw/refs/heads/master/derivus_jupyter.py) 
and is not included in the core derivus package (as it's solely a GUI and not necessary to run any calculations)
...
defined. All interest rates in Derivus are assumed to be NACC (Nominal Annual Compounded Continuously).  
...
The basic idea in derivus is to define all inputs that would normally be associated with pricing a financial instrument 
