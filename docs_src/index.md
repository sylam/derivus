...
Derivus is a python framework for performing derivatives pricing and related quantitative finance
by utilizing Facebook's Pytorch library. Derivus is designed to work either on CPU's or nvidia
...
the motivations for Derivus are:
