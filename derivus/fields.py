    ...
    'Instrument': {
        ...
        'sections': {
            ...
            'EquitySwapletListDeal.Fields': ['Accrual_Calendars', 'Settlement_Days', 'Equity', 'Equity_Currency',
                                             ...
                                             'Equity_Cashflows', 'Equity_Volatility'],
            ...
            'CommodityFutureDeal.Fields': ['Commodity', 'Maturity_Date', 'Repo_Rate', 'Carry', 'Currency'],
            'CashAccountDeal.Fields': ['Currency', 'Discount_Rate', 'Investment_Horizon', 'Units'],
            ...
            'FXDiscreteExplicitDoubleAsianOption.Fields': [
                'Currency', 'Discount_Rate', 'Expiry_Date', 'FX_Volatility', 'Option_Type', 'Buy_Sell',
                'Underlying_Currency', 'Underlying_Amount', 'Strike_Price', 'Strike_Multiplier',
                'Sampling_Data_1', 'Sampling_Multiplier_1', 'Sampling_Data_2', 'Sampling_Multiplier_2'],
            'FXPartialTimeBarrierOption.Fields': [
                'Currency', 'Discount_Rate', 'Expiry_Date', 'FX_Volatility', 'Option_Type', 'Buy_Sell',
                'Underlying_Currency', 'Underlying_Amount', 'Payoff_Currency', 'Strike_Price',
                'Barrier_Price', 'Barrier_Type', 'Barrier_At_Start', 'Barrier_Limit_Date',
                'Barrier_Monitoring_Frequency', 'Cash_Rebate'],
            ...
            'MtMCrossCurrencySwapDeal.Fields': ['Pay_Discount_Rate', 'Pay_Rate_Type', 'Receive_Interest_Rate',
                                                'Maturity_Date', 'Principal_Exchange', 'Pay_Interest_Rate',
                                                'Receive_Discount_Rate', 'Receive_Rate_Type', 'Effective_Date',
                                                'Pay_Currency', 'MtM_Side', 'Receive_Currency',
                                                'Pay_Interest_Rate_Volatility', 'Pay_Discount_Rate_Volatility',
                                                'Receive_Interest_Rate_Volatility',
            ...
            'FloatingEnergyDeal.Fields': ['Currency', 'Discount_Rate', 'Sampling_Type', 'FX_Sampling_Type',
                                          ...
                                          'Reference_Volatility', 'Payoff_Currency', 'Commodity'],
        ...
        'types': {
            ...
            'CommodityFutureDeal':
                ['Admin', 'CommodityFutureDeal.Fields'],
            'CashAccountDeal':
                ['Admin', 'CashAccountDeal.Fields'],
            'EquityOptionDeal':
            ...
            'FXDiscreteExplicitDoubleAsianOption':
                ['Admin', 'FXAdmin', 'FXDiscreteExplicitDoubleAsianOption.Fields'],
            'FXPartialTimeBarrierOption':
                ['Admin', 'FXAdmin', 'FXPartialTimeBarrierOption.Fields'],
            'FXSwapDeal':
        ...
        'fields': {
            ...
            'Index_Reference_Type': {'name': 'Reference_Type', 'widget': 'Dropdown', 'description': 'Reference Type', 'value': 'Interpolated',
            ...
            'Adjustment_Method': {'name': 'Rate_Adjustment_Method', 'widget': 'Dropdown', 'description': 'Rate Adjustment Method', 'value': 'None',
            ...
            'Barrier_Limit_Date': {'widget': 'DatePicker', 'description': 'Barrier Limit Date', 'value': ''},
            'Barrier_At_Start': {'widget': 'Dropdown', 'description': 'Barrier At Start', 'value': 'No',
                                 'values': ['Yes', 'No']},
            ...
            'Barrier_Type_One': {'name': 'Barrier_Type', 'widget': 'Dropdown', 'description': 'Barrier Type', 'value': 'Up',
                                 'values': ['Up', 'Down']},
            'Option_Payment_Timing': {'name': 'Payment_Timing', 'widget': 'Dropdown', 'description': 'Payment Timing', 'value': 'Expiry',
                                      'values': ['Touch', 'Expiry']},
            ...
            # the double-asian averages two independent sampling schedules against one strike
            'Sampling_Data_1': {'widget': 'Table', 'description': 'Sampling_Data_1', 'value': 'null',
                                'sub_types':
                                    [{'type': 'date', 'dateFormat': 'YYYY-MM-DD'},
                                     {'type': 'numeric', 'numericFormat': num_format['currency']},
                                     {'type': 'numeric', 'numericFormat': num_format['currency']}
            ...
            'Sampling_Data_2': {'widget': 'Table', 'description': 'Sampling_Data_2', 'value': 'null',
                                'sub_types':
                                    [{'type': 'date', 'dateFormat': 'YYYY-MM-DD'},
                                     {'type': 'numeric', 'numericFormat': num_format['currency']},
                                     {'type': 'numeric', 'numericFormat': num_format['currency']}
            ...
            # double-asian weights: payoff is alpha_0*K - alpha_1*A_1 + alpha_2*A_2, all defaulting to 1
            'Strike_Multiplier': {'widget': 'Float', 'description': 'Strike Multiplier', 'value': 1.0},
            'Sampling_Multiplier_1': {'widget': 'Float', 'description': 'Sampling Multiplier 1', 'value': 1.0},
            'Sampling_Multiplier_2': {'widget': 'Float', 'description': 'Sampling Multiplier 2', 'value': 1.0},
            ...
            'Collateral_Assets': {'widget': 'Container', 'description': 'Collateral Assets',
                                  ...
                                  'sub_fields': ['Cash_Collateral', 'Bond_Collateral', 'Equity_Collateral',
                                                 'Commodity_Collateral']},
            'Float_Cashflows': {'name': 'Cashflows', 'widget': 'Container', 'description': 'Cashflows',
            ...
            'Equity_Cashflows': {'name': 'Cashflows', 'widget': 'Container', 'description': 'Cashflows',
                                'value': {"Items": []}, 'sub_fields': ['EquityItems']},
            'Fixed_Cashflows': {'name': 'Cashflows', 'widget': 'Container', 'description': 'Cashflows',
                                'value': {"Compounding": "No", "Items": []},
                                'sub_fields': ['Compounding', 'FixedItems']},
            'Fixed_Simple_Cashflows': {'name': 'Cashflows', 'widget': 'Container', 'description': 'Cashflows', 'value': {"Items": []},
                                       'sub_fields': ['FixedSimpleItems']},
            'Real_Yield_Cashflows': {'name': 'Cashflows', 'widget': 'Container', 'description': 'Cashflows', 'value': {"Items": []},
                                     'sub_fields': ['RealYieldItems']},
            'Energy_Cashflows': {'name': 'Payments', 'widget': 'Container', 'description': 'Payments', 'value': {"Items": []},
                                 'sub_fields': ['EnergyItems']},
            'Energy_Fixed_Cashflows': {'name': 'Payments', 'widget': 'Container', 'description': 'Payments', 'value': {"Items": []},
            ...
            'Carry': {'widget': 'Text', 'description': 'Carry', 'value': '', 'obj': 'Tuple'},  # tuple
            'CDS_Index': {'widget': 'Text', 'description': 'CDS Index', 'value': '', 'obj': 'Tuple'},  # tuple
