...
(derivus/pricing.py sim_spot_tarf), opt-in per deal via the ``SpotModel='HestonNandi'``
Valuation Configuration switch (derivus/instruments.py FXTARFOptionDeal).
...
# reference-derivus shadow-import guard (see MEMORY: `import derivus` can resolve to an old
