...
functions whose true derivatives are known - deliberately NOT on derivus deals, because the deals
...
def test_report_grad_hands_out_a_copy_not_a_live_view():
    ...
    itself when the next measure's backward runs. derivus builds three estimators per batch
    ...
    import torch
    from derivus.pricing import SensitivitiesEstimator
